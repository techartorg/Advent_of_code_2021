...
uses four segments, eafb means that to render a 4, signal lines e, a, f, and 
b are on.
...
def part_one(input_):
    """Return how often the digits 1, 4, 7, and 8 are displayed."""
...
def part_two(input_):
    """Translate the displayed digits and add them up."""
    ...
    for l in input_.splitlines():
        ...
        # Filter the digits based on how many wires they need.
        ...
        # Deduce the digits with the same number of wires by comparing
        # against known digits.
